  ...
  <section className='flex flex-col items-center gap-6 py-8'>
    ...
    <SliderControls>
      {tours.map(tour => (
        <div
          key={tour.title}
          className='flex-[0_0_100%] sm:flex-[0_0_33.33%] px-2'
        >
          <div className='bg-white shadow-md rounded-md overflow-hidden'>
            <div className='relative h-60'>
              ...
              />
              <div className='absolute bottom-0 left-0 w-full bg-black/50 text-white px-2 py-2 text-sm'>
                {tour.title}
              </div>
            </div>

            <div className='p-3 text-center bg-orange-400 text-white mt-[-1px]'>
              <p className='text-sm'>
              ...
              <button className='mt-3 border border-white px-4 py-1 text-sm rounded'>
                ПОДРОБНЕЕ
              </button>
            </div>
          </div>
